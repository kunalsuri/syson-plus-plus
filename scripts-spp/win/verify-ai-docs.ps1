...
.DESCRIPTION
    ...
    To run only one side, use the targeted scripts directly:
      .\scripts-spp\win\verify-ai-docs-backend.ps1
...
.EXAMPLE
    .\scripts-spp\win\verify-ai-docs.ps1            # full audit (both backend + frontend)
    .\scripts-spp\win\verify-ai-docs-backend.ps1    # backend devs: Java / GraphQL
    .\scripts-spp\win\verify-ai-docs-frontend.ps1   # frontend devs: TypeScript / TSX
#>
[CmdletBinding()]
param(
    [switch]$GenerateOnly,
...
Write-Host "    .\scripts-spp\win\verify-ai-docs-backend.ps1    (Java / GraphQL / Grammar)"
Write-Host "    .\scripts-spp\win\verify-ai-docs-frontend.ps1   (TypeScript / TSX)"
Write-Host ""
