...
.DESCRIPTION
    ...
    First time on a new machine? Run .\scripts-spp\win\dev-setup.ps1 instead.
...
function Stop-WithError($msg) {
    ...
    Write-Host "  First time? Run: .\scripts-spp\win\dev-setup.ps1" -ForegroundColor Yellow
...
Write-Host "  |                                                         |" -ForegroundColor Green
Write-Host "  |   To stop:  .\scripts-spp\win\dev-stop.ps1                 |" -ForegroundColor Green
Write-Host "  +---------------------------------------------------------+" -ForegroundColor Green
Write-Host ""
