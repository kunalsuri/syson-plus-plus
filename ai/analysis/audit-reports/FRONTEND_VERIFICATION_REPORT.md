...
|---|---|---|
| ✅ Confirmed (file found in frontend/) | 0 | n/a |
| ❌ Not found — fix or remove from catalog | 0 | n/a |
| 📐 Pattern template (intentional Xxx placeholder) | 0 | n/a |
...
- [ ] **Re-run** after fixes: `.\scripts-spp\verify-ai-docs-frontend.ps1`
