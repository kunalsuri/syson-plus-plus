...
# Feature Catalog — syson-plus-plus Master Index
...
>
> **Cold-start snapshot — 2026-06-27** (commit `<commit-hash>`), once generated.
>
...
Depending on the complexity of syson-plus-plus, the catalog can live in a single file or be split to reduce token context overhead:
